...
# .env
echo "DATABASE_URL=postgresql://admin:LocalPasswordOnly@postgres:5433/quizzable-dev?schema=public" >.env

# apps/functions/.env
echo "DATABASE_URL=postgresql://admin:LocalPasswordOnly@postgres:5433/quizzable-dev?schema=public" >apps/functions/.env
echo "PRISMA_QUERY_ENGINE_LIBRARY=../../node_modules/prisma/libquery_engine-debian-openssl-3.0.x.so.node" >>apps/functions/.env
echo "TEST_DATABASE_URL=postgresql://admin:LocalPasswordOnly@postgres:5433/quizzable-test?schema=public" >>apps/functions/.env

# apps/web/.env
echo "DATABASE_URL=postgresql://admin:LocalPasswordOnly@postgres:5433/quizzable-dev?schema=public" >apps/web/.env
...
echo "TEST_DATABASE_URL=postgresql://admin:LocalPasswordOnly@postgres:5433/quizzable-test?schema=public" >>apps/web/.env

# packages/e2e/.env
echo "BASE_URL=http://localhost:3000" >packages/e2e/.env
echo "DATABASE_URL=postgresql://admin:LocalPasswordOnly@postgres:5433/quizzable-dev?schema=public" >>packages/e2e/.env
...
echo "TEST_DATABASE_URL=postgresql://admin:LocalPasswordOnly@postgres:5433/quizzable-test?schema=public" >>packages/e2e/.env
